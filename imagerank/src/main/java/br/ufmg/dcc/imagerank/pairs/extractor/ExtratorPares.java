...
public class ExtratorPares
{
	...
	public void processar() throws ProcessorException
	{
		...
		{
			throw new ProcessorException(String.format("Parâmetros de entrada informados inválidos. Diretório base: '%s' -  Diretório imagens: '%s' -  Diretório descritores: '%s'", this.diretorioBase, this.diretorioImagens, this.diretorioDescritores));
		}
		else
		{
