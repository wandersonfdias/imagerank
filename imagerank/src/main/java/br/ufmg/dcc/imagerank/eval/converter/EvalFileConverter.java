package br.ufmg.dcc.imagerank.eval.converter;
...
/**
 * Converte arquivos de saída do LAC em arquivos de entrada (prediction e feature) para uso pelo EvalScore.
...
public class EvalFileConverter
{
	 ...
	 * @throws ProcessorException
	 */
	private void convertFeatureFile() throws IOException, ProcessorException
	{
		...
		for (String linhaArquivo : linhasArquivo)
		{
			...
			String[] pairId = StringUtils.split(dadosLinha[0], ImageRankConstants.PAIR_ID_SEPARATOR);
	 ...
	 * @throws ProcessorException
	 */
	private void convertPredictionFile() throws IOException, ProcessorException
	{
		// lê o arquivo original e adiciona o attributo que identifica o par de imagens às instâncias do dataset
